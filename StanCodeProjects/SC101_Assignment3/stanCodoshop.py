...
TODO: The project print a new picture without people which is composed from several pictures.
"""
...
def solve(images):
    ...
    for x in range(width):
        for y in range(height):
            ...
            best_pxl = get_best_pixel(lst)
            new_pixel.red = best_pxl.red
            new_pixel.green = best_pxl.green
            new_pixel.blue = best_pxl.blue
    ######## YOUR CODE ENDS HERE ###########
